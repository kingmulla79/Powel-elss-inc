...
('AC Unit Replacement - Office Block B', 'HVAC', 'In Progress', 'Replace faulty air conditioning unit', 'Nairobi, Westlands', 'medium', '240', 12, '2025-09-20 09:00:00', 'Access via basement parking'),
('Leaking Pipe Repair - Hotel Kitchen', 'Plumbing', 'Completed', 'Seal leak in main kitchen water pipe', 'Mombasa, CBD', 'high', '120', 25, '2025-09-22 14:00:00', 'Water supply will be shut off during repair'),
('Security Camera Installation - Warehouse', 'Electrical', 'Rejected', 'Install and configure 4 CCTV cameras', 'Kisumu, Industrial Area', 'low', '300', 33, '2025-09-25 08:30:00', 'All equipment provided on-site'),
('Elevator Maintenance - Apartment Block A', 'Mechanical', 'Assigned', 'Routine elevator safety inspection and servicing', 'Nairobi, Kilimani', 'medium', '180', 18, '2025-09-10 10:00:00', 'Maintenance log to be updated after work'),
('Roof Leak Repair - Residential House', 'Roofing', 'In Progress', 'Replace damaged shingles and seal leak', 'Eldoret, Langas', 'high', '240', 7, '2025-09-19 07:30:00', 'Owner will be present during work'),
('Parking Lot Light Replacement', 'Electrical', 'Completed', 'Replace 6 faulty floodlights', 'Nairobi, South C', 'medium', '200', 22, '2025-09-23 17:00:00', 'Ladder and lift available on-site'),
('Fire Alarm System Testing - Hospital', 'Safety', 'Rejected', 'Test and reset all fire alarm units', 'Nakuru, CBD', 'high', '150', 44, '2025-09-26 11:00:00', 'Notify staff before triggering alarms'),
('Ceiling Fan Installation - Community Hall', 'Electrical', 'Assigned', 'Install 3 ceiling fans', 'Kisii, Nyanchwa', 'low', '180', 36, '2025-09-21 09:15:00', 'Fans provided by client'),
('Pest Control - Grocery Store', 'Sanitation', 'In Progress', 'Spray and set traps for rodents', 'Nairobi, Donholm', 'high', '120', 11, '2025-09-05 06:00:00', 'Work to be done before store opens'),
('Fence Welding - Factory Perimeter', 'Metalwork', 'Completed', 'Repair broken steel fence sections', 'Thika, Makongeni', 'medium', '210', 40, '2025-09-29 08:00:00', 'Safety gear required'),
('Water Pump Servicing - Borehole', 'Plumbing', 'Rejected', 'Lubricate and check pump functionality', 'Kitale, Milimani', 'low', '180', 19, '2025-09-27 10:30:00', 'Spare parts available if needed'),
('Tile Replacement - School Corridor', 'Masonry', 'Assigned', 'Replace cracked floor tiles', 'Nairobi, Umoja', 'medium', '240', 27, '2025-09-16 13:00:00', 'Students on break during repair'),
('Signboard Installation - Restaurant', 'Carpentry', 'In Progress', 'Mount new exterior signboard', 'Mombasa, Nyali', 'low', '150', 6, '2025-09-30 15:00:00', 'Requires drilling into concrete'),
('Generator Repair - Office Complex', 'Electrical', 'Completed', 'Fix starter motor issue', 'Nairobi, Karen', 'high', '210', 14, '2025-09-17 07:00:00', 'Client requests minimal downtime'),
('Door Lock Replacement - Hotel Suite', 'Carpentry', 'Rejected', 'Replace broken electronic lock', 'Naivasha, Town Center', 'medium', '90', 29, '2025-09-12 12:00:00', 'Provide new keycards'),
('Pavement Crack Sealing - Driveway', 'Masonry', 'Assigned', 'Seal and resurface cracked areas', 'Nairobi, Runda', 'low', '180', 4, '2025-09-28 14:00:00', 'Dry weather needed for work'),
('Window Frame Replacement - Office', 'Glasswork', 'In Progress', 'Install new aluminum window frames', 'Kisumu, CBD', 'high', '300', 17, '2025-09-24 09:45:00', 'Old frames already removed'),
('IT Network Cabling - Data Center', 'Networking', 'Completed', 'Run new Cat6 cables and terminate', 'Nairobi, Upper Hill', 'high', '360', 42, '2025-09-15 08:00:00', 'Work after peak hours preferred'),
('Garden Sprinkler Installation', 'Plumbing', 'Rejected', 'Install automatic irrigation system', 'Nakuru, Milimani', 'medium', '240', 32, '2025-09-07 07:30:00', 'System connected to main water line'),
('Glass Partition Installation - Office', 'Glasswork', 'Assigned', 'Fit and secure glass partition panels', 'Nairobi, CBD', 'medium', '200', 10, '2025-09-18 11:00:00', 'Handle glass with care'),
('Solar Panel Maintenance - School Roof', 'Electrical', 'In Progress', 'Clean and check solar panels for efficiency', 'Machakos, Town Center', 'low', '180', 21, '2025-09-13 09:00:00', 'Avoid working during rain'),
('Boiler Servicing - Textile Factory', 'Mechanical', 'Completed', 'Service boiler and replace worn-out parts', 'Eldoret, Industrial Area', 'high', '300', 45, '2025-09-19 08:30:00', 'Wear protective clothing'),
('Street Light Repair - Highway Section', 'Electrical', 'Rejected', 'Replace damaged street lights', 'Nairobi, Outering', 'medium', '240', 2, '2025-09-28 20:00:00', 'Night shift required'),
('Air Duct Cleaning - Mall', 'HVAC', 'Assigned', 'Clean air ducts to improve airflow', 'Nairobi, CBD', 'low', '200', 31, '2025-09-22 07:45:00', 'Access from maintenance room'),
('Printer Repair - Government Office', 'IT Support', 'In Progress', 'Fix paper jam and service printer', 'Kisumu, Milimani', 'medium', '90', 13, '2025-09-16 11:00:00', 'Parts available on-site'),
('Exterior Painting - Residential Block', 'Painting', 'Completed', 'Repaint exterior walls and balconies', 'Mombasa, Tudor', 'high', '360', 24, '2025-09-26 09:30:00', 'Use weatherproof paint'),
('Server Rack Installation - Data Center', 'Networking', 'Rejected', 'Assemble and install new server racks', 'Nairobi, Upper Hill', 'medium', '300', 5, '2025-09-18 08:00:00', 'Check electrical load before setup'),
('Kitchen Hood Cleaning - Restaurant', 'Sanitation', 'Assigned', 'Deep clean kitchen exhaust hood', 'Thika, CBD', 'low', '150', 48, '2025-09-14 06:30:00', 'Work before opening hours'),
('Parking Gate Automation', 'Mechanical', 'In Progress', 'Install automatic gate motors', 'Nairobi, Karen', 'high', '240', 35, '2025-09-27 13:00:00', 'Test system before handover'),
('Cold Room Servicing - Butchery', 'HVAC', 'Completed', 'Service refrigeration system', 'Nakuru, CBD', 'high', '180', 41, '2025-09-17 06:00:00', 'Keep products chilled during service'),
('Shower Mixer Replacement - Apartment', 'Plumbing', 'Rejected', 'Replace faulty shower mixer tap', 'Nairobi, Donholm', 'medium', '90', 1, '2025-09-29 10:00:00', 'Tenant will be at home'),
('Emergency Exit Sign Installation', 'Electrical', 'Assigned', 'Install illuminated emergency exit signs', 'Eldoret, CBD', 'low', '120', 26, '2025-09-21 16:00:00', 'Test battery backup'),
('Conference Room AV Setup', 'IT Support', 'In Progress', 'Install projector and sound system', 'Kisumu, Milimani', 'medium', '210', 30, '2025-09-19 15:30:00', 'Cables to be concealed'),
('Roof Gutter Cleaning - Office', 'Roofing', 'Completed', 'Remove debris from roof gutters', 'Nairobi, Westlands', 'low', '150', 16, '2025-09-25 07:00:00', 'Dispose waste properly'),
('CCTV System Upgrade - Bank', 'Security', 'Rejected', 'Replace DVR and cameras', 'Nairobi, CBD', 'high', '300', 9, '2025-09-23 09:15:00', 'Security clearance required'),
('Landscaping - Hotel Garden', 'Gardening', 'Assigned', 'Trim hedges and plant flowers', 'Mombasa, Nyali', 'medium', '240', 46, '2025-09-15 07:45:00', 'Use client’s preferred plants'),
('Garage Door Repair - Warehouse', 'Mechanical', 'In Progress', 'Repair motorized garage door', 'Thika, Industrial Area', 'medium', '200', 20, '2025-09-28 11:15:00', 'Lubricate all moving parts'),
('Water Heater Installation - Clinic', 'Plumbing', 'Completed', 'Install electric water heater', 'Nairobi, Kilimani', 'high', '180', 39, '2025-09-20 14:00:00', 'Test before leaving site'),
('Floor Polishing - Office Lobby', 'Cleaning', 'Rejected', 'Polish marble floor', 'Nakuru, CBD', 'medium', '150', 23, '2025-09-18 18:00:00', 'Use non-slip polish'),
('Backup Generator Fueling', 'Electrical', 'Assigned', 'Refuel standby generator', 'Nairobi, Karen', 'low', '60', 28, '2025-09-19 05:30:00', 'Check oil levels'),
('PABX System Setup - Office', 'IT Support', 'In Progress', 'Install and configure telephone exchange', 'Nairobi, Upper Hill', 'medium', '240', 2, '2025-09-24 10:00:00', 'Label all extensions'),
('Swimming Pool Pump Repair', 'Plumbing', 'Completed', 'Fix pool water pump', 'Mombasa, Bamburi', 'high', '150', 47, '2025-09-21 12:00:00', 'Check filtration system'),
('Fire Extinguisher Refilling - School', 'Safety', 'Rejected', 'Refill 20 fire extinguishers', 'Kisumu, CBD', 'medium', '180', 34, '2025-09-29 08:30:00', 'Tag all serviced units'),
('Warehouse Shelving Installation', 'Carpentry', 'Assigned', 'Install heavy-duty shelves', 'Nairobi, Industrial Area', 'high', '300', 8, '2025-09-15 09:00:00', 'Bolt shelves to the floor'),
('Borehole Chlorination', 'Plumbing', 'In Progress', 'Chlorinate borehole water system', 'Kitale, Milimani', 'low', '120', 43, '2025-09-18 07:15:00', 'Measure chlorine levels'),
('Escalator Repair - Shopping Mall', 'Mechanical', 'Completed', 'Replace escalator belt', 'Nairobi, CBD', 'high', '240', 50, '2025-09-22 10:30:00', 'Test after repair'),
('Office Partition Demolition', 'Construction', 'Rejected', 'Remove old partitions', 'Nairobi, Westlands', 'medium', '180', 15, '2025-09-25 08:00:00', 'Dispose debris responsibly'),
('Printer Networking Setup - Library', 'IT Support', 'Assigned', 'Connect printers to network', 'Thika, CBD', 'low', '90', 3, '2025-09-16 13:15:00', 'Install drivers on all PCs');
